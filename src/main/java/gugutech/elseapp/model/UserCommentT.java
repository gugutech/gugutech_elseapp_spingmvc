...
public class UserCommentT {
    ...
    private Integer connentedUserId;
    ...
    public Integer getConnentedUserId() {
        return connentedUserId;
    }

    public void setConnentedUserId(Integer connentedUserId) {
        this.connentedUserId = connentedUserId;
    }
    ...
    public void setSeg16(String seg16) {
        this.seg16 = seg16 == null ? null : seg16.trim();
    }
}